...
class GraphsApplication(Adw.Application):
    ...
    def connect_actions(self):
        ...
        self.create_action('mode_none', self.set_mode, ['N', '1'], InteractionMode.NONE)
        self.create_action('mode_pan', self.set_mode, ['P', '2'], InteractionMode.PAN)
        self.create_action('mode_zoom', self.set_mode, ['Z', '3'], InteractionMode.ZOOM)
        self.create_action('mode_select', self.set_mode, ['S', '4'], InteractionMode.SELECT)
