...
If you wish to contribute to translating Graphs, you can join a language theme, more information on that can be found on the [GNOME Translation Project Wiki.](https://wiki.gnome.org/TranslationProject)
