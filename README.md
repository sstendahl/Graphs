...
Apart from regular operations, Graphs also has support for curve fitting on the data, allowing you to allowing you to effortlessly analyze trends within your datasets.
